...
def data_exploration() -> pd.DataFrame:
    """reads in the dataset and prints it's statistical descriptions"""
...
def tests_and_pdfs(df: pd.DataFrame) -> None:
    ...
    positive_currents = df[df["Peak Current"] > 0]
    bestDistributions(
        positive_currents["Peak Current"], "Magnitude", choosen_distributions
    )
